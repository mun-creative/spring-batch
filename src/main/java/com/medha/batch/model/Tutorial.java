...
public class Tutorial {
	...
	public String toString() {
		return "Tutorial [tutorial_id=" + tutorial_id + ", tutorial_author="
				+ tutorial_author + ", tutorial_title=" + tutorial_title
				+ ", submission_date=" + submission_date + ", tutorial_icon="
